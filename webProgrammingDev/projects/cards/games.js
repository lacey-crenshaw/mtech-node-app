...
function wrongAnswer() {
    ...
    document.getElementById(flippedone).style.backgroundImage = "url('cards.png/card.png')";
    document.getElementById(flippedtwo).style.backgroundImage = "url('cards.png/card.png')";
    cardsflipped = 0;
}
